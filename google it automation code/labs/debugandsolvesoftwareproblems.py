...
#we change the following function by adding reader as a parameter, and take the data reading out of it
...
#we add the following new function to process the data
...
#we define reader by calling the new function and get_file_lines
